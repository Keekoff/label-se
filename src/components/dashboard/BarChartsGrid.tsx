...
export const BarChartsGrid = ({
  ...
  const getSocialImpactChartData = () => {
    // Prioritize using the raw percentage directly from Airtable
    const socialImpactValue = companyData?.["Développement d'impact social positif (%)"] !== undefined 
      ? parseFloat(companyData["Développement d'impact social positif (%)"]) 
      : companyData?.developpementImpactSocialPositifPercentage !== undefined 

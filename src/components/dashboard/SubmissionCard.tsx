...
export const SubmissionCard = ({
  ...
  return <Card className="border border-[#27017F]/40 shadow-[0_8px_30px_rgba(0,0,0,0.08)] bg-gradient-to-r from-[#F1F1F1]/90 to-[#F1F1F1]/70 backdrop-blur-sm rounded-xl">
      <CardContent className="p-4 sm:p-8">
        <div className="space-y-6">
          ...
          <div className="flex flex-wrap gap-4">
            {paymentStatus === 'unpaid' && <Button onClick={onPayment} className="bg-[#35DA56] text-white transition-shadow duration-300 shadow-md border border-[#35DA56]/20 px-4 sm:px-6 py-3 sm:py-5 h-auto w-full sm:w-auto" disabled={isLoading}>
            ...
            {paymentStatus === 'paid' && <Button variant="outline" onClick={() => navigate('/dashboard/justificatifs')} className="backdrop-blur-sm text-[#27017F] hover:text-white transition-colors duration-300 shadow-md border border-white/60 px-4 sm:px-6 py-3 sm:py-5 h-auto w-full sm:w-auto bg-[35DA56] bg-[#38d858]">
